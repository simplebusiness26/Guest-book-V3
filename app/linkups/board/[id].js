  ...
  return(
    <View style={styles.screen}>
      ...
      {!readOnly&&<View style={styles.composer}>
        ...
        <View style={styles.composerRow}><TextInput value={body} onChangeText={setBody} maxLength={1000} multiline placeholder="Message attendees" placeholderTextColor="#777780" style={styles.input}/><Pressable style={[styles.sendButton,(!body.trim()||working)&&styles.disabled]} disabled={!body.trim()||working} onPress={post}>{working?<ActivityIndicator color="white"/>:<Text style={styles.sendText}>Send</Text>}</Pressable></View>
...
const styles=StyleSheet.create({
  screen:{flex:1,backgroundColor:"#18181b"},messages:{flex:1},content:{padding:16,paddingBottom:24},center:{flex:1,backgroundColor:"#18181b",alignItems:"center",justifyContent:"center",padding:28},errorTitle:{color:"white",fontSize:22,fontWeight:"900"},errorText:{color:"#aaaab3",textAlign:"center",marginTop:8},backButton:{backgroundColor:"#3212b6",borderRadius:12,padding:13,marginTop:17},backText:{color:"white",fontWeight:"900"},
  headerCard:{backgroundColor:"#29233b",borderColor:"#504373",borderWidth:1,borderRadius:16,padding:15,marginBottom:14},eyebrow:{color:"#a994e7",fontSize:9,fontWeight:"900",letterSpacing:.8},title:{color:"white",fontSize:23,fontWeight:"900",marginTop:5},when:{color:"#b9afca",fontSize:12,marginTop:7},readOnlyBanner:{color:"#ffd49a",backgroundColor:"#4c3518",borderRadius:9,padding:9,marginTop:10,fontWeight:"800",fontSize:11,overflow:"hidden"},
  emptyCard:{backgroundColor:"#222226",borderColor:"#414147",borderWidth:1,borderRadius:15,padding:28,alignItems:"center"},emptyIcon:{fontSize:36},emptyTitle:{color:"white",fontSize:18,fontWeight:"900",marginTop:8},emptyText:{color:"#9999a3",textAlign:"center",lineHeight:19,marginTop:5},
  messageCard:{backgroundColor:"#222226",borderColor:"#3f3f46",borderWidth:1,borderRadius:15,padding:13,marginBottom:10},myMessage:{borderColor:"#57458b",backgroundColor:"#282139"},announcementCard:{backgroundColor:"#17384e",borderColor:"#2d6a8d"},messageTop:{flexDirection:"row",alignItems:"center"},avatar:{width:38,height:38,borderRadius:19,backgroundColor:"#3212b6",alignItems:"center",justifyContent:"center"},avatarText:{color:"white",fontWeight:"900"},authorText:{flex:1,marginLeft:9},author:{color:"white",fontWeight:"900"},time:{color:"#85858e",fontSize:10,marginTop:2},announcementBadge:{color:"#bfeaff",fontSize:8,fontWeight:"900"},body:{color:"#dedee5",lineHeight:21,marginTop:11},deletedBody:{color:"#777780",fontStyle:"italic"},messageActions:{flexDirection:"row",justifyContent:"flex-end",gap:16,marginTop:10},removeText:{color:"#ff8d9d",fontWeight:"900",fontSize:11},reportText:{color:"#c7a85a",fontWeight:"900",fontSize:11},
  reportPanel:{backgroundColor:"#2c2c31",borderRadius:11,padding:10,marginTop:10},reasonWrap:{flexDirection:"row",flexWrap:"wrap",gap:5},reason:{borderColor:"#505058",borderWidth:1,borderRadius:16,paddingHorizontal:9,paddingVertical:6},reasonActive:{backgroundColor:"#3212b6"},reasonText:{color:"#aaaab3",fontSize:9,fontWeight:"800"},reasonTextActive:{color:"white"},submitReport:{backgroundColor:"#8f171f",borderRadius:9,padding:9,alignItems:"center",marginTop:9},submitReportText:{color:"white",fontWeight:"900",fontSize:11},
  composer:{backgroundColor:"#202024",borderTopColor:"#3b3b41",borderTopWidth:1,padding:12,paddingBottom:18},announcementToggle:{alignSelf:"flex-start",borderColor:"#51446f",borderWidth:1,borderRadius:16,paddingHorizontal:10,paddingVertical:6,marginBottom:8},announcementToggleActive:{backgroundColor:"#17435a",borderColor:"#2e7093"},announcementToggleText:{color:"#a79abb",fontSize:10,fontWeight:"900"},announcementToggleTextActive:{color:"#c7edff"},composerRow:{flexDirection:"row",alignItems:"flex-end",gap:8},input:{flex:1,maxHeight:110,minHeight:46,backgroundColor:"#2a2a2f",borderColor:"#484850",borderWidth:1,borderRadius:12,color:"white",paddingHorizontal:12,paddingVertical:11},sendButton:{backgroundColor:"#3212b6",borderRadius:11,minWidth:72,height:46,alignItems:"center",justifyContent:"center"},sendText:{color:"white",fontWeight:"900"},counter:{color:"#777780",fontSize:9,textAlign:"right",marginTop:4},disabled:{opacity:.55}
});
