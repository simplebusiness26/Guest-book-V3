...
const styles=StyleSheet.create({
  ...
  errorText:{color:"#666",textAlign:"center",marginTop:10,lineHeight:21},
  headingRow:{flexDirection:"row",alignItems:"flex-start",gap:14},
  headingText:{flex:1},
  title:{fontSize:30,fontWeight:"bold"},
  subtitle:{fontSize:15,color:"#666",lineHeight:22,marginTop:6},
  countBadge:{minWidth:72,backgroundColor:"#fff1df",borderWidth:1,borderColor:"#f0c581",borderRadius:14,paddingVertical:10,paddingHorizontal:12,alignItems:"center"},
  countNumber:{fontSize:23,fontWeight:"bold",color:"#8a4d00"},
  countLabel:{fontSize:11,color:"#8a4d00",fontWeight:"bold",textTransform:"uppercase"},
  topButtons:{flexDirection:"row",gap:10,marginTop:18,marginBottom:24},
  secondaryButton:{flex:1,borderWidth:1,borderColor:"#aeb5c0",backgroundColor:"white",padding:12,borderRadius:10},
  secondaryButtonText:{textAlign:"center",fontWeight:"bold",color:"#263447"},
  focusSection:{backgroundColor:"white",borderRadius:16,padding:18,borderWidth:2,borderColor:"#275bd6"},
  clubSection:{backgroundColor:"white",borderRadius:16,padding:18,borderWidth:1,borderColor:"#dfe3e8",marginBottom:18},
  sectionEyebrow:{fontSize:11,fontWeight:"bold",color:"#275bd6",letterSpacing:0.6,marginBottom:6},
  sectionTitle:{fontSize:22,fontWeight:"bold"},
  sectionSub:{fontSize:14,color:"#68717b",lineHeight:20,marginTop:4},
  clubHeader:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:12,marginBottom:14},
  clubHeaderText:{flex:1},
  clubCapacity:{backgroundColor:"#eee9ff",color:"#5633a8",fontWeight:"bold",paddingHorizontal:11,paddingVertical:7,borderRadius:18,overflow:"hidden"},
  capacityCard:{backgroundColor:"#f1edff",borderRadius:10,padding:12,marginTop:14},
  capacityText:{color:"#5633a8",fontWeight:"bold"},
  requestCard:{backgroundColor:"#f7f8fb",borderRadius:13,padding:15,borderWidth:1,borderColor:"#dfe3e8",marginTop:12},
  focusedRequestCard:{backgroundColor:"#fff9df",borderColor:"#d29b00",borderWidth:2},
  focusLabel:{fontSize:11,fontWeight:"bold",color:"#8a5c00",marginBottom:11},
  memberIdentity:{flexDirection:"row",alignItems:"center"},
  memberAvatar:{width:50,height:50,borderRadius:25,backgroundColor:"#ddd"},
  memberAvatarFallback:{width:50,height:50,borderRadius:25,backgroundColor:"#5633a8",alignItems:"center",justifyContent:"center"},
  memberInitial:{color:"white",fontWeight:"bold",fontSize:20},
  memberNameWrap:{marginLeft:12,flex:1},
  applicantName:{fontSize:18,fontWeight:"bold",color:"#20262d"},
  memberMeta:{fontSize:12,color:"#737b84",marginTop:4},
  noteCard:{backgroundColor:"white",borderRadius:10,padding:12,marginTop:13,borderWidth:1,borderColor:"#e1e4e8"},
  noteLabel:{fontSize:10,fontWeight:"bold",color:"#6c7480",letterSpacing:0.4},
  noteText:{fontSize:15,color:"#343b43",lineHeight:21,marginTop:6},
  buttonRow:{flexDirection:"row",gap:10,marginTop:14},
  approveButton:{flex:1,backgroundColor:"#218739",padding:14,borderRadius:10},
  rejectButton:{flex:1,backgroundColor:"#c23b3b",padding:14,borderRadius:10},
  disabledButton:{opacity:0.5},
  buttonText:{color:"white",fontWeight:"bold",textAlign:"center"},
  viewGroupButton:{borderWidth:1,borderColor:"#275bd6",padding:13,borderRadius:10,marginTop:14},
  viewGroupText:{color:"#275bd6",fontWeight:"bold",textAlign:"center"},
  completedCard:{backgroundColor:"#edf8f0",borderWidth:1,borderColor:"#b8dfc2",borderRadius:16,padding:24,alignItems:"center"},
